...
CREATE TABLE IF NOT EXISTS public.households (
  ...
  recurring_tasks_onboarding_completed_at timestamptz,
...
-- ---------------------------------------------------------------------------
-- v3 : favoris, déclarations datées, multi-participants
-- ---------------------------------------------------------------------------
...
-- J) supabase/scripts/supabase_v3_favorites_declarations_rls.sql (v3 : RLS favoris + déclarations ; tables déjà dans ce baseline)
--
